# CeruleanIR Compiler - x86 backend
# By Amy Burnett
# June 19 2024
# ========================================================================
...
LIB_FILENAME = os.path.dirname (__file__) + "/CeruleanIR_BuiltinLib_x86.asm"
...
class CodeGenVisitor_x86 (ASTVisitor):
    ...
    def visitProgramNode (self, node):
        ...
        self.printHeader ("x86-64 generated from CeruleanIR Compiler")
        self.printDivider ()
        self.printNewline ()
