# CeruleanRISC Linker: Processes and combines 1 or more CeruleanRISC object code files into a single
# CeruleanRISC bytecode file.
# =================================================================================================
...
class Linker:
    ...
    def addEntrySection (self, objectCodes, globalSymbolTable):
        ...
        if self.entrySymbol not in globalSymbolTable:
            ...
            print (f"   Required to determine program start location for CeruleanRISCVM")
...
if __name__ == "__main__":
    ...
    argparser = argparse.ArgumentParser(description="CeruleanRISC Linker")
    argparser.add_argument(dest="inputFilenames", nargs="+", help="CeruleanRISC object files to link")
    argparser.add_argument("-o", "--outputFilename", dest="outputFilename", default="a.criscbc", help="name for the outputted linked file")
