...
if __name__ == "__main__":
    ...
    argparser = argparse.ArgumentParser(description="CeruleanRISC Assembler")
    argparser.add_argument(dest="sourceFilename", help="CeruleanRISC file to assemble")
    ...
    if args.outputFilename:
        ...
        destFilename = os.path.splitext(args.sourceFilename)[0] + ".crisco"
