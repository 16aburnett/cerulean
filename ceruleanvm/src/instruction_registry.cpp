...
const std::unordered_map<Opcode, InstructionInfo> instructionRegistry = {
    ...
    {Opcode::CVTI32I64, {"CVTI32I64", "RR", ""  }},
    {Opcode::CVTI64I32, {"CVTI64I32", "RR", ""  }},
    {Opcode::CVTU32U64, {"CVTU32U64", "RR", ""  }},
    {Opcode::CVTU64U32, {"CVTU64U32", "RR", ""  }},
    {Opcode::CVTF32I32, {"CVTF32I32", "RR", ""  }},
    {Opcode::CVTI32F32, {"CVTI32F32", "RR", ""  }},
    {Opcode::CVTF64I64, {"CVTF64I64", "RR", ""  }},
    {Opcode::CVTI64F64, {"CVTI64F64", "RR", ""  }},
    {Opcode::CVTF32U32, {"CVTF32U32", "RR", ""  }},
    {Opcode::CVTU32F32, {"CVTU32F32", "RR", ""  }},
    {Opcode::CVTF64U64, {"CVTF64U64", "RR", ""  }},
    {Opcode::CVTU64F64, {"CVTU64F64", "RR", ""  }},
    ...
    {Opcode::OR32, {"OR32", "RRR", "" }},
    {Opcode::OR64, {"OR64", "RRR", "" }},
    {Opcode::AND32, {"AND32", "RRR", "" }},
    {Opcode::AND64, {"AND64", "RRR", "" }},
    {Opcode::XOR32, {"XOR32", "RRR", "" }},
    ...
    {Opcode::OR32I, {"OR32I", "RRI", "" }},
    {Opcode::OR64I, {"OR64I", "RRI", "" }},
    {Opcode::AND32I, {"AND32I", "RRI", "" }},
    {Opcode::AND64I, {"AND64I", "RRI", "" }},
    {Opcode::XOR32I, {"XOR32I", "RRI", "" }},
