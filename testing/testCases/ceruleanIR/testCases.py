...
function i32 @main () {
    ...
    block for_cond {
        ...
        jge (i32(%i_curr), i32(13), block(for_end))
        jmp (block(for_body))
    }
    block for_body {
        %char = load (type(char), ptr("Hello, World!"), i32(%i_curr))
